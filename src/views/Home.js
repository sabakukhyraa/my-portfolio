      ...
      <div className="flex flex-col items-center justify-center gap-8 pb-24 ">
        ...
        <div className="mb-24 skills">
          ...
          <p className="text-lg font-medium text-gray">
            I'm working as a Frontend Developer for 1.5 years. I think writing
        ...
        <div className="skills">
          ...
          <p className="text-lg font-medium text-gray">
            I'm pretty new at Backend. I'm trying to learn everything and while
            I learn Backend, I understand Frontend better.
          </p>
